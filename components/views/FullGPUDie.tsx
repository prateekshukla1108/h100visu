  ...
  return (
    <div className="fade-in pb-12">
      <h2 className={`text-center font-tech font-bold mb-8 text-2xl tracking-wider uppercase drop-shadow-[0_0_10px_rgba(34,211,238,0.5)] ${isB200 ? 'text-green-400' : 'text-cyan-400'}`}>
        Full GPU Die Layout <span className="text-sm text-slate-500 align-middle ml-2 font-sans font-normal normal-case tracking-normal">({isB200 ? '264 Active SMs - Dual Die' : '132 Active SMs'})</span>
      </h2>
