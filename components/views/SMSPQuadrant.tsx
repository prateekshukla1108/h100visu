...
const SMSPQuadrant: React.FC<SMSPQuadrantProps> = ({ onUnitClick }) => {
  ...
  return (
    <div className="fade-in w-full pb-12">
      <h2 className="text-center text-neon-green font-tech font-bold mb-8 text-2xl tracking-widest border-b border-slate-800 pb-4 mx-auto max-w-3xl uppercase drop-shadow-[0_0_5px_rgba(0,255,65,0.5)]">
        <span className="text-cyan-400">SMSP Quadrant</span> <span className="text-sm text-slate-500 align-middle ml-2 normal-case font-sans font-normal tracking-normal block md:inline mt-1 md:mt-0">(Processing Block Structure)</span>
      </h2>
      ...
      <div className="max-w-[800px] mx-auto bg-slate-950/80 backdrop-blur border-2 border-slate-800 rounded-xl overflow-hidden p-4 shadow-[0_0_40px_rgba(0,243,255,0.1)]">
        ...
        <div className="grid grid-cols-[1fr_1fr_1fr_1fr_1.8fr] border border-slate-800 bg-slate-900 rounded-sm overflow-hidden">
          ...
          >
            ...
            <div className="text-[10px] font-bold mt-4 text-green-500 border border-green-800/50 px-3 py-1 rounded bg-black/40 backdrop-blur-sm">4<sup>th</sup> GENERATION</div>
          </div>
        </div>
