...
const Specs: React.FC = () => {
  ...
  return (
    <div className="fade-in max-w-7xl mx-auto">
      <h2 className="text-center text-pink-500 font-tech font-bold mb-12 text-3xl tracking-widest uppercase drop-shadow-[0_0_10px_rgba(236,72,153,0.6)]">
        H100 Technical Specifications
      </h2>

      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 mb-12">
        {stats.map((stat, i) => (
          <div key={i} className="bg-slate-900/60 border border-slate-700 rounded-lg p-6 shadow-lg hover:border-cyan-500/50 hover:shadow-[0_0_20px_rgba(6,182,212,0.2)] transition-all duration-300 group relative overflow-hidden">
      ...
      <div className="glass-panel rounded-xl overflow-hidden shadow-2xl border border-slate-700">
        <div className="bg-slate-900/80 px-8 py-6 border-b border-slate-700">
